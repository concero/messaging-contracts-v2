...
import {Storage as s, Namespaces} from "contracts/ConceroPriceFeed/libraries/Storage.sol";

contract PriceFeedStorage is ConceroPriceFeedTest {
    ...
    function test_SetStorageBulk() public {
        ...
        vm.startPrank(deployer);
        conceroPriceFeed.setStorageBulk(namespaces, offsets, mappingKeys, values);
    ...
    function test_RevertInvalidStorageSlot() public {
        ...
        vm.prank(deployer);
        conceroPriceFeed.setStorage(invalidNamespace, 0, bytes32(0), 1);
    }
    ...
    function test_RevertLengthMismatch() public {
        ...
        namespaces[1] = Namespaces.PRICEFEED;
