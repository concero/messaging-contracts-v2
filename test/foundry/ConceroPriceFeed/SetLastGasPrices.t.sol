...
contract SetLastGasPricesTest is ConceroTest {
    ...
    function test_setLastGasPrices() public {
        ...
        uint256 storedGasPriceA = s_conceroPriceFeed.getLastGasPrice(CHAIN_SELECTOR_A);
        uint256 storedGasPriceB = s_conceroPriceFeed.getLastGasPrice(CHAIN_SELECTOR_B);
        uint256 storedGasPriceC = s_conceroPriceFeed.getLastGasPrice(CHAIN_SELECTOR_C);
    ...
    function test_setLastGasPrices_SingleChain() public {
        ...
        uint256 storedGasPrice = s_conceroPriceFeed.getLastGasPrice(CHAIN_SELECTOR_A);
