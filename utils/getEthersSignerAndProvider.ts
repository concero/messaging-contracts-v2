...
export function getEthersV5FallbackSignerAndProvider(networkName: ConceroNetworkNames) {
...
export function getEthersV6FallbackSignerAndProvider(networkName: ConceroNetworkNames): {
